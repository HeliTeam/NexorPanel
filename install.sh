#!/bin/bash
# =============================================================================
# NEXOR FORK: Upstream release tarballs still ship the binary and unit as "x-ui".
# For a pure Nexor install, build from this repo (`go build -o nexor .`) and use
# deploy/nexor.service with paths under /usr/local/nexor, /etc/nexor, /var/log/nexor.
# This script is retained for compatibility with MHSanaei/3x-ui release layouts.
# =============================================================================
