// Package web provides the main web server implementation for the Nexor panel,
...
import (
	...
	"github.com/nexor/panel/util/common"
	"github.com/nexor/panel/web/controller"
	restpkg "github.com/nexor/panel/web/controller/rest"
	"github.com/nexor/panel/web/job"
	"github.com/nexor/panel/web/locale"
	"github.com/nexor/panel/web/middleware"
	"github.com/nexor/panel/web/network"
	"github.com/nexor/panel/web/service"
	"github.com/nexor/panel/web/websocket"
...
// Server represents the main web server for the Nexor panel with controllers, services, and scheduled jobs.
type Server struct {
...
func (s *Server) initRouter() (*gin.Engine, error) {
	...
	engine.Use(sessions.Sessions("nexor", store))
	...
	restpkg.RegisterRestAPI(engine, &s.xrayService)
...
func (s *Server) startTask() {
	...
	// Nexor: expire / traffic cap / inactive cleanup / session TTL prune
	s.cron.AddJob("@every 1m", job.NewNexorVpnCronJob())
