...
import (
	...
	"github.com/nexor/panel/util/random"
	"github.com/nexor/panel/util/reflect_util"
	"github.com/nexor/panel/web/entity"
...
func (s *SettingService) ResetSettings() error {
	...
	return db.Session(&gorm.Session{AllowGlobalUpdate: true}).Delete(&model.Admin{}).Error
}
...
func (s *SettingService) GetNexorJWTSecret() (string, error) {
	return s.getString("nexorJwtSecret")
}

func (s *SettingService) SetNexorJWTSecret(v string) error {
	return s.setString("nexorJwtSecret", v)
}
