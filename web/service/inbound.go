// Package service provides business logic services for the Nexor web panel,
...
// GetClientPrimaryKey returns the protocol-specific identifier used by Xray/panel APIs for a client.
func (s *InboundService) GetClientPrimaryKey(protocol model.Protocol, client model.Client) string {
