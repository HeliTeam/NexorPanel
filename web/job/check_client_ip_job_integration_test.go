...
import (
	...
	xuilogger "github.com/nexor/panel/logger"
	"github.com/op/go-logging"
)

// Nexor logger must be initialised once before any code path that can
...
func setupIntegrationDB(t *testing.T) {
	...
	if err := database.InitDB(filepath.Join(dbDir, "nexor-test.db")); err != nil {
...
func readIpLimitLogPath() string {
	...
	return filepath.Join(folder, "nexor-ipl.log")
}
