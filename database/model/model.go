// Package model defines the database models and data structures used by the Nexor panel.
package model

import (
	"fmt"

	"github.com/nexor/panel/util/json_util"
...
// Admin is a panel administrator (login: nickname + password). Stored in table "admins".
type Admin struct {
	Id           int    `json:"id" gorm:"primaryKey;autoIncrement"`
	Nickname     string `json:"nickname" gorm:"uniqueIndex;size:128"`
...
// Setting stores key-value configuration settings for the Nexor panel.
type Setting struct {
	Id    int    `json:"id" form:"id" gorm:"primaryKey;autoIncrement"`
